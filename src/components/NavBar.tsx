...
import { Bell, CircleUserRound, MessageCircleMore, UsersRound } from 'lucide-react'
...
const NavBar: FC = () => {
	...
	return (
		<section className={'flex justify-between items-center w-full  gap-4 '}>
			<div className={'font-black w-32 text-xl text-primary md:hidden lg:block '}>
				<span>
					<Link href={'/'}>DeMaster</Link>
				</span>
			</div>
			<div className={'md:flex gap-8 flex-1 justify-start hidden text-base-content w-1/2'}>
